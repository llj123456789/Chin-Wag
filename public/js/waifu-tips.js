...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://api.scustu.cn');
});
...
(function (){
    ...
    if (true) {      // 如果是主页
        ...
        if (now > 23 || now <= 5) {
            ...
            text = '上午好！要像aboy<span style="color:#FF66AA;font-weight:bold;"></span>一样勤勤劳劳！';
...
function ifActed() {
    if (!hitokotoInterval) {
        ...
        hitokotoTimer = window.setInterval(showHitokoto, 8000);
    }
}
...
function showHitokoto(){
    $.getJSON('https://api.scustu.cn/yiyan',function(result){
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', 'https://api.scustu.cn/live2d/'+modelId, console.log('live2d','模型 '+modelId+' 加载完成'));
}
...
function loadRandModel(){
    ...
    $.ajax({
        success: function (){
            ...
            if(a==0)
            {
                showMessage('<span style="color:#FF66AA;font-weight:bold;"></span>要求ABoy<span style="color:#66AAFF;font-weight:bold;"></span>给我买了很多套衣服呢~你看！', 3000, true);
            }else if(a==1)
            {
                showMessage('<span style="color:#FF66AA;font-weight:bold;"></span>ABoy<span style="color:#66AAFF;font-weight:bold;"></span>说还要给我买一件呢！', 3000, true);
            }else 
            {
                showMessage('<span style="color:#FF66AA;font-weight:bold;"></span><span style="color:#66AAFF;font-weight:bold;"></span>我新衣服好看吗？ABoy给我买的！', 3000, true);
            }
